...
from src.proofreading.domain.models import ProofreadResult
from src.proofreading.infrastructure.vertex_gemini_proofreader import (
    VertexGeminiProofreader,
)


def _make_proofreader(mock_genai: MagicMock) -> VertexGeminiProofreader:
    with patch(
        "src.proofreading.infrastructure.vertex_gemini_proofreader."
...
@patch("src.proofreading.infrastructure.vertex_gemini_proofreader.genai")
class TestVertexGeminiProofreader:
